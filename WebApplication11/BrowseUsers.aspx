<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="BrowseUsers.aspx.cs" Inherits="WebApplication11.WebForm11" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageBody" runat="server">
    ...
    <asp:Label ID="noUsersLabel" Font-Size="20px" runat="server"></asp:Label>
    <asp:DataList ID="AllUsersDataList" runat="server">
        <ItemTemplate>
