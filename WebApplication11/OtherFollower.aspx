<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="OtherFollower.aspx.cs" Inherits="WebApplication11.WebForm9" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageBody" runat="server">
    ...
    <asp:Label ID="noFollowerLabel" Font-Size="20px" runat="server"></asp:Label>
    <asp:DataList ID="FollowerDataList" runat="server">
        <ItemTemplate>
